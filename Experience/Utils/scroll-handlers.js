...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Fixed contact container:', fixedContactContainer);
    ...
    function handleScroll() {
        ...
        if (sixthMoveMarker) {
            ...
            if (scrollPosition > sixthMovePosition) {
                ...
                console.log('Showing fixed containers');
                if (fixedContactContainer) fixedContactContainer.style.display = 'block';
                if (fixedPortfolioInfo) fixedPortfolioInfo.style.display = 'block';
            } else {
                // User has not yet scrolled to the sixth section marker
                console.log('Hiding fixed containers');
                if (fixedContactContainer) fixedContactContainer.style.display = 'none';
